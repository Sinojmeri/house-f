    ...
    return (
        <div className="pl-2">
            ...
            <div className="flex gap-2 items-center">
                ...
                <img src={favIcon} alt="empty heart" onClick={() => favIcon === '/heart_icon.png' ? setFavIcon('/fav_heart.png') : setFavIcon('/heart_icon.png')}
                    className="w-[25px] h-[25px] cursor-pointer" />
            </div>

            <div className="bg-white my-3 w-full pl-2 flex-row">
                <p className="italic text-lg">Address: <span className="font-bold">{listing.address}</span></p>
                <p className="text-xl mb-2">Total Price: <span>??? €</span></p>
                    ...
                    >
                        ...
                        {listing.images.map((images) => (
                            <SwiperSlide key={images._id}>
                                <img src={`${BASE_URL}${images.img}`} alt="House Pic" className="h-[350px] rounded-md" />
                            </SwiperSlide>
                        ))}
                    </Swiper>
                    <div className="flex flex-col">
                        ...
                        <div className="grid grid-cols-3 gap-2 mx-auto">
                            {listing.amenities.map((amenitiy) => (
                                <p className="flex p-1 border-2 rounded-lg bg-blue-300 text-center my-auto h-[90px] md:h-auto justify-center items-center"
                                    key={amenitiy}>{amenitiy}
                                </p>
                            ))}
                            <p className="p-1 border-2 rounded-lg bg-blue-300 text-center"><span>Number of Beds: </span>{listing.nrOfBeds}</p>
                            <p className="p-1 border-2 rounded-lg bg-blue-300 text-center"><span>Number of Rooms: </span>{listing.nrOfRooms}</p>
                        </div>
                    </div>
                </div>
