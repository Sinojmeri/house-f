  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col gap-2 ml-2">
        ...
        <input
          type="text"
          className="bg-inherit p-1 w-fit border-2 border-black rounded-lg outline-none"
        ...
        <input
          type="text"
          className="bg-inherit p-1 w-fit border-2 border-black rounded-lg outline-none cursor-pointer"
