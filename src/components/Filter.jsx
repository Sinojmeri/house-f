...
export default function Filter() {
    ...
    const handleOutsideFilter = (event) => {
        if (!filterDiv.current.contains(event.target) && !filterInput.current.contains(event.target)) {
        ...
        <div className="flex flex-col gap-2 my-2">
            ...
            <div className="flex gap-1 p-1 justify-between items-center">
                <div className="flex gap-1 border-2 border-gray-100 p-1 items-center w-[95%] ml-1">
                    ...
                    <div className="relative w-full">
                        <input className='p-1 focus:outline-none items-center w-full' value={inputValue} onChange={(event) => handleChange(event.target.value)}
                            ...
                            onBlur={onBlur}
                            ref={filterInput} />
                        <div className={`bg-slate-100 absolute mt-2 w-full md:w-[500px] rounded-md z-[20] ${displayFilter}`}
                            ref={filterDiv}
                        >
                            <ul>
                ...
                <div className="relative">
                    ...
                    <div ref={calendarDivRef} className={`absolute right-0 ${showCalendar ? '' : 'hidden'} z-[100]`}>
                        <Flatpickr
                            ref={calendarRef}
