...
export function BookingDetailsCard({ listing }) {
    ...
    return (
        <div className="bg-white shadow-lg rounded-lg p-4 w-[300px] cursor-pointer"
            onClick={() => navigate(`/bookings/${listing._id}?startDate=${displayStartDate}&endDate=${displayEndDate}`)}>
            <img
